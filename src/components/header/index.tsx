      ...
      <Group style={{}} position="apart">
        <Group spacing={50}>
          ...
          {!isMobile && <Group sx={{ zIndex: 5 }} spacing={13}>
            <Text className={classes.abnormalText} size={10}>FB</Text>
            <Text className={classes.abnormalText} size={10}>IN</Text>
          </Group>}
        </Group>
        <Center>
        ...
        <Group>
          <Group sx={{ zIndex: 5 }} spacing={40}>
            <Text className={classes.abnormalText} size={10}>EN</Text>
